...
export function MatchDetailSkeleton({ onBack }) {
  return (
    <div
      className="screen score-screen history-detail-screen history-detail-overlay loading-shell match-detail-skeleton"
      aria-busy="true"
    >
      ...
      <div className="detail-content">
        ...
        {/* 2. Score Grid Skeleton - Cấu trúc khớp với ScoreGrid thật */}
